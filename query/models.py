...
class Record(models.Model):
    ...
    test_type = models.ForeignKey(TestType, on_delete=models.CASCADE, verbose_name="测试类型")
    result_integer = models.IntegerField(u'测试结果', default=100)
    ...
    def __str__(self):
        return "%s_%s" % (self.test_type, self.pub_date)
